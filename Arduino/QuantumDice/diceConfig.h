...
#define DICE_SET_S010 10  //BLCK1 (prehistoric)
#define DICE_SET_S020 20  //BART3
#define DICE_SET_S021 21  //BART4
...
//background color of display
// use one of the following colors, 0x  BLACK, BLUE, RED, GREEN, CYAN, MAGNETA, YELLOW, WHITE, ORNAG, GREY, BORDEAUX, DINOGREEN, WHITE
#define X_BACKGROUND GC9A01A_BLACK
#define Y_BACKGROUND GC9A01A_BLACK
#define Z_BACKGROUND GC9A01A_BLACK
#define ENTANG_AB1_COLOR GC9A01A_YELLOW
...
//ESP32 SMD v3.2 n16r8,
#elif SELECTED_DICE_SET == DICE_SET_S020
#define DICE_ID "BART3"
#define SMD //default SMD. Optional HDR for ancient processor boards
#define DEVKIT //default DEVKIT. Optional NANO for processorPCB based on Arduino ESP32 nano board

//0xD0, 0xCF, 0x13, 0x33, 0x58, 0x70	
//0xD0, 0xCF, 0x13, 0x36, 0x40, 0x94

inline uint8_t deviceA_mac[6] = { 0xD0, 0xCF, 0x13, 0x33, 0x58, 0x70 }; // MAC address of device A
inline uint8_t deviceB1_mac[6] = { 0xD0, 0xCF, 0x13, 0x36, 0x40, 0x94 };  // MAC address of device B
inline uint8_t deviceB2_mac[6] = { 0xDC, 0xDA, 0xC, 0x21, 0x2, 0x44 };  // DUMMY. Replace with actual mac adress. Use 3rd dice with the teleportation experiment
...
//ESP32 SMD v3.2 n16r8,
#elif SELECTED_DICE_SET == DICE_SET_S021
#define DICE_ID "BART4"
#define SMD //default SMD. Optional HDR for ancient processor boards
#define DEVKIT //default DEVKIT. Optional NANO for processorPCB based on Arduino ESP32 nano board

//0xD0, 0xCF, 0x13, 0x36, 0x40, 0x34
//0xD0, 0xCF, 0x13, 0x33, 0x58, 0x2C

inline uint8_t deviceA_mac[6] = { 0xD0, 0xCF, 0x13, 0x36, 0x40, 0x34 }; // MAC address of device A
inline uint8_t deviceB1_mac[6] = { 0xD0, 0xCF, 0x13, 0x33, 0x58, 0x2C };  // MAC address of device B
inline uint8_t deviceB2_mac[6] = { 0xDC, 0xDA, 0xC, 0x21, 0x2, 0x44 };  // DUMMY. Replace with actual mac adress. Use 3rd dice with the teleportation experiment
